<template>
    <div>
        ...
        <div id="lowPriceBanner">
            <img src="../assets/images/images/banner.png" alt="">
        </div>
        <!-- 商品展示部分 -->
...
#lowPriceNav {
    ...
    .nav-btn {
        ...
        .btn {
            ...
            // border-left:1px solid #eee;
            text-align: center;
            background: url('../../src/assets/images/images/icon-search.png');
        ...
        .btn1 {
            ...
            text-align: center;
            background-color: #fbfbfb;
            background: url('../../src/assets/images/images/icon-colse.png');
            background-repeat: no-repeat;
            background-position: center center;
            background-size: 22px auto;
        }
...
#lowPriceSearch {
    ...
    >.search-l {
        ...
        i {
            ...
            width: 30px;
            height: 30px;
            background: url('../../src/assets/images/images/icon-search1.png');
